...
****/
            ...
            _itoa_s(move, moveChar, 2, 10);

            UDP_send(s, moveChar, 2, remoteIP.c_str(), remotePort.c_str());
...
****/
                ...
                status = UDP_recv(s, moveChar, 2, const_cast<char *>(remoteIP.c_str()),
                                  const_cast<char *>(remotePort.c_str()));

                int moveInt = atoi(moveChar);
                updateBoard(board, moveInt, opponent);
                displayBoard(board);
